...
typedef vm_phb_req_error_enum (*_vm_phb_delete_contact_t)(vm_phb_delete_req_struct *req_info, vm_phb_callback_type cb);
_vm_phb_delete_contact_t _vm_phb_delete_contact = NULL;
...
vm_phb_req_error_enum vm_phb_delete_contact(vm_phb_delete_req_struct *req_info, vm_phb_callback_type cb)
{
    ...
    if (NULL != _vm_phb_delete_contact)
        return _vm_phb_delete_contact(req_info,cb);
