 ...
 * PARAMETERS
 *  ulPin : [IN] Analog output pin number; 8, 9
 ...
 * DESCRIPTION
 *  Outputs analog value (PWM wave) to the assigned analog output pin.
 *  Note: Only the analog output pins D8 and D9 support analog output.
 ...
 *  analogRead
 * DESCRIPTION
 *  Reads the value of an assigned analog input pin.
 * PARAMETERS
 *  ulPin : [IN] Analog input pin number to be read;A0,A1,A2 or A3
 * RETURNS
 * uint32_t:0 to 1023
 * EXAMPLE
 *	<code>
